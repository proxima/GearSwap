...
windower.send_command('bind ^h gs c toggle zerodmg')     -- Ctrl+H to toggle whether you close skillchains with a helix
...
function get_sets()
    ...
    Lugh.ADOULIN     = { name="Bookworm's Cape", augments={'INT+5','MND+1','Helix eff. dur. +20',}}
    ...
    sets.me.melee_dw = set_combine(sets.me.melee, {
      ...
      back=Lugh.DEX_STP -- Make dw + dex version
    })
