...
function init_gear_sets()
  ...
  sets.midcast.Aquaveil = {
    ...
    right_ring="Defending Ring",
    back={ name="Fi Follet Cape +1", augments={'Path: A',}},                                   --  5
  }
  ...
  sets.engaged.DW.MidHaste = set_combine(sets.engaged.DW.LowHaste, {}) -- 27%
  ...
  sets.engaged.DW.HighHaste = set_combine(sets.engaged.DW.MidHaste, {}) -- 22%
  ...
  sets.engaged.DW.MaxHaste = set_combine(sets.engaged.DW.HighHaste, {}) -- 6%
