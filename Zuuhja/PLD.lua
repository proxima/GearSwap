...
function user_setup()
  ...
  send_command('bind @v sat youcommand Suuhja "Dream Flower"')
...
function init_gear_sets()
  ...
  sets.precast.JA['Divine Emblem'] = set_combine(sets.precast.Enmity, {feet="Chevalier's Sabatons +3"})
  ...
  sets.midcast.Phalanx = {
	...
	body={ name="Valorous Mail", augments={'CHR+9','Pet: Phys. dmg. taken -3%','Phalanx +4','Accuracy+10 Attack+10','Mag. Acc.+7 "Mag.Atk.Bns."+7',}},
  ...
  sets.idle.Meva = {
    ...
    body="Sakpata's Breastplate",     -- 10
    hands="Chevalier's gauntlets +3", -- 11
    legs="Chevalier's cuisses +3",    -- 13
