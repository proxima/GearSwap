...
--              [ F12 ]             Update Current Gear / Report Current 
...
function user_setup()
    ...
    send_command('bind @a send zuuhja input /ma "Indi-Frailty" <me>')
    send_command('bind @s sat youcommand Zuuhja Geo-Malaise')
    send_command('bind @d send zuuhja input /ma "Cure" Dotnet')
    ...
    send_command('bind @n sat youcommand Muuhja "Mewing Lullaby"')
